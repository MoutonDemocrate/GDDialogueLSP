...
exports.dialogueManagerTags = exports.effectTags = exports.builtinTags = void 0;
exports.tagToMarkdown = tagToMarkdown;
...
function getAllTagNames() {
    return [...exports.builtinTags, ...exports.dialogueManagerTags, ...exports.effectTags].map(tag => tag.name);
}
// Helper to find a tag by name from builtin, dialogue manager, or effect tags
function findTag(name) {
    return [...exports.builtinTags, ...exports.dialogueManagerTags, ...exports.effectTags].find(tag => tag.name === name);
}
